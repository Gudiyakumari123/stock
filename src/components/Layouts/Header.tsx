        ...
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="">
                <div className="relative bg-white flex w-full items-center justify-between px-5 py-2.5 dark:bg-black">
                    ...
                    <div className='flex justify-between'>
                        <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                            <Link to="/" className="main-logo flex items-center shrink-0" style={{ maxWidth: "100px" }}>
                                <img className="ltr:-ml-1 rtl:-mr-1 inline rounded" src={logo} alt="logo" />
                            </Link>
                            {/* <button
                                type="button"
                    ...
                    <div className='flex justify-between'>
                        <ul className="horizontal-menu   hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white">
                            ...
                            <li className="menu nav-item relative">
                                <NavLink to="#">
                                    <button type="button" className=" p-2 rounded ">
                                        <div className="flex items-center">
                                            {/* <IoNotifications /> */}
                                            <span className="px-1">Courses</span>
                                        </div>
                                    </button>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item relative">
                                <NavLink to="#">
                                    <button type="button" className=" p-2 rounded ">
                                        {/* focus:ring-violet-300 focus:bg-[#eee]  */}
                                        <div className="flex items-center">
                                            {/* <IoNotifications /> */}
