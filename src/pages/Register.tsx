    ...
    return (
        <div className="relative mb-5 isolate overflow-hidden sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            <div className="absolute inset-0 -z-10 bg-cover bg-center bg-no-repeat opacity-5 animate-move-background"
                style={{ backgroundImage: "url('https://media.istockphoto.com/id/1661021853/photo/woman-watching-stock-charts.webp?b=1&s=170667a&w=0&k=20&c=sKn3OsTaCryYm7r1lYyyFjgac92xlrFNH0uM8MK614M=')" }} />
            <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 ">
                <div className='w-full max-w-[440px] bg-white dark:bg-[#161616]  rounded-xl lg:mt-16 p-10' >
                    <form className="space-y-1 dark:text-white h-full rounded-xl ">
                        ...
                        <h1 className='text-2xl mt-1 font-bold flex justify-center  !leading-snug text-[#FFAA33]  md:text-2xl text-center' >Welcome to Aura</h1>
                        <p className=' flex justify-center text-green-700  ' >Please Fill all the fields to Register </p>
                        <div >
                            <input type="text" placeholder='Name' className="w-full rounded-lg  bg-[#F2F2F2] px-4 py-2  text-xs font-normal   text-black mb-1 " />
                        </div>
                        <div >
                            <input type="phone" placeholder='Number' className="w-full rounded-lg  bg-[#F2F2F2] px-4 py-2  text-xs font-normal  text-black mb-1 " />
                        </div>

                        <div >
                            <input type="password" placeholder='Email Id' className="w-full rounded-lg  bg-[#F2F2F2] px-4 py-2  text-xs font-normal  text-black mb-1 " />
                        </div>
                        <div >
